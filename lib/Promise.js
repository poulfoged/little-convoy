        ...
        var BasePromise = (function () {
            ...
            BasePromise.prototype.then = function (success, error, progress) {
                ...
                if (this.__isUnfulfilled()) {
                    ...
                    queueTaskToEventLoop(function () {
                        that.__handleCallbacks([callbackObj]);
                    });
                }
                return prom;
            };

            BasePromise.prototype.progressed = function (p) {
                return this.then(null, null, p);
            };

            BasePromise.prototype.catch = function (e) {
                return this.then(null, e);
            };

            BasePromise.prototype.finally = function (e) {
            ...
            BasePromise.prototype.__waitFor = function (prom) {
                ...
                prom.then(function onSuccess(val) {
                    ...
                    that.__callProgressCallbacks(progress);
                });
            };
